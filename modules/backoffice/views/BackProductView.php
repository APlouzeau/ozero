    ...
    public function show() {
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 mb-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <label for="add-product-modal" class="btn btn-primary gap-2 mt-4 md:mt-0">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex gap-2">
                                    <label for="edit-product-modal"
                                           class="btn btn-sm btn-outline text-blue-600 border-blue-600 hover:bg-blue-600 hover:border-blue-600"
                                           ...
                                           data-category="<?= $productModel->getIdCategoryByProduct($product->getProductId()) ? htmlspecialchars($productModel->getIdCategoryByProduct($product->getProductId())) : 'NULL' ?>">
                                           <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                    </label>

                                    <button class="btn btn-sm btn-outline text-red-600 border-red-600 hover:bg-red-600 hover:border-red-600"
                                            data-product-id="<?= $product->getProductId() ?>"
