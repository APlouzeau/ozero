...
?>
    ...
    ?>
        ...
        <div class="mt-10 pt-6 border-t border-gray-200 text-center">
                        <a href="/catalogue" class="inline-block px-6 py-3 bg-primary text-white font-semibold rounded-lg shadow-md hover:bg-primary/90 transition-colors text-lg">
                            Convaincu? Découvrez nos produits!
                        </a>
                    </div>
    ...
    ?>
                ...
                <div class="lg:flex lg:gap-8">
                    ...
                    <div class="lg:w-1/4 mb-6 lg:mb-0">
                        <div class="bg-white rounded-lg shadow-md p-6 sticky top-4">
                            <h2 class="text-lg font-semibold text-gray-900 mb-4 font-supreme">Filtres</h2>
                            
                            <div class="mb-6">
                                <h3 class="text-sm font-medium text-gray-900 mb-3">Catégories</h3>
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        <input id="category-all" name="category" type="radio" value="all" class="h-4 w-4 text-primary focus:ring-primary" checked>
                                        <label for="category-all" class="ml-2 text-sm text-gray-700">Toutes les catégories</label>
                                    </div>
                                    <?php foreach ($categories as $category) { ?>
                                        <div class="flex items-center">
                                            <input id="category-<?= $category->getCategoryId() ?>" name="category" type="radio" value="<?= $category->getCategoryId() ?>" class="h-4 w-4 text-primary focus:ring-primary category-filter">
                    ...
                    <div class="lg:w-3/4">
                        ...
                        <div class="bg-white rounded-lg shadow-md p-4 mb-6 flex flex-col sm:flex-row justify-between items-center">
                            <div class="flex items-center mb-4 sm:mb-0">
                                ...
                                <select id="sort-options" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary p-2">
                            ...
                            <div class="flex items-center space-x-2">
                                <button id="grid-view" class="p-2 rounded-md bg-primary/10 text-primary hover:bg-primary/20 focus:outline-none view-toggle active">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                                    </svg>
                                </button>
                                <button id="list-view" class="p-2 rounded-md text-gray-500 hover:bg-gray-100 focus:outline-none view-toggle">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="flex justify-between items-center">
                                            <div class="flex space-x-2">
                                                <a href="/articles/<?= $article->getArticleId() ?>" class="inline-flex items-center px-3 py-1.5 border border-primary text-xs font-medium rounded text-primary bg-white hover:bg-primary/5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                                                    Voir le tutoriel
                                                </a>
                        ...
                        <div id="no-products-message" class="hidden bg-white rounded-lg shadow-md p-8 text-center">
                            ...
                            <button id="reset-filters" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Fonction pour basculer entre la vue grille et liste
            ...
            function filterProducts() {
                ...
                // Afficher le message si aucun produit ne correspond aux filtres
            ...
            function sortProducts(sortOption) {
                ...
                products.sort((a, b) => {
                    ...
                    // Par défaut, retourne dans l'ordre original
                    return 0;
                });
            ...
            sortOptions.addEventListener('change', () => {
                sortProducts(sortOptions.value);
            });
            
            // Ajouter des écouteurs d'événements aux boutons radio de catégorie
            categoryFilters.forEach(filter => {
                filter.addEventListener('change', filterProducts);
            });
            
            // Si le bouton "Appliquer les filtres" existe, ajouter un écouteur d'événement
            if (applyFiltersBtn) {
            ...
            // Appliquer les filtres au chargement pour s'assurer que tout est correct dès le début
            filterProducts();
        });
        </script>
    <?php
